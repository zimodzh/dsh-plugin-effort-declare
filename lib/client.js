	...
	factory: (require) => {
		...
		*/
		...
		const PRESETS = {
			...
			toggle: {
				...
				compat: { supportsReasoningEffort: "set-false" },
				warnSameWire: true
			}
		};
		...
		*/
		...
		var effort_declare_module_css_default = {
			...
			"dangerButton": "hYEBUa_dangerButton",
			"error": "hYEBUa_error",
		...
		*/
		...
		function dirty(draft) {
			return JSON.stringify(draft.models) !== JSON.stringify(draft.originalModels) || JSON.stringify(draft.compat) !== JSON.stringify(draft.originalCompat);
		}
		...
		*/
		...
		function ModelRowEditor(props) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					err !== void 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
							...
							disabled: disabled || !dirty(draft) || draft.models.length === 0 || clientError !== void 0,
							onClick: () => {
								props.onSave(draft);
							},
		...
		function EffortDeclareSection(props) {
			...
			const [formats, setFormats] = (0, react.useState)([...FALLBACK_THINKING_FORMATS]);
			...
			(0, react.useEffect)(() => {
				if (props.onInvalidate === void 0) return void 0;
				return props.onInvalidate(() => {
					reload();
				});
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					status === "ready" && drafts.length === 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
						className: effort_declare_module_css_default.notice,
						children: t("empty")
					}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
						className: effort_declare_module_css_default.intro,
		...
		function apply(ctx) {
			try {
				ctx.effect(() => ctx.locale.register(NS, {
					zh,
					en
				}), "dsh-plugin-effort-declare: dictionaries");
